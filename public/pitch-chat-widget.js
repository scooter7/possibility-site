// The Possibility - Pitch Deck Chat Widget
// Investor-focused AI assistant connected exclusively to pitch deck content
(function () {
  'use strict';

  var STREAM_URL = '/api/pitch-chat-stream';
  var FALLBACK_URL = '/api/pitch-chat-stream';
  var MAX_HISTORY = 40;

  var STORAGE_KEY = 'poss-pitch-chat-history';
  var isOpen = false;
  ...
  panel.innerHTML =
    '<div class="poss-chat-header">' +
      ...
      '<div class="poss-chat-header-text">' +
        '<div class="poss-chat-header-title">Investor Intelligence</div>' +
        '<div class="poss-chat-header-sub">Ask anything about the pitch deck.</div>' +
      '</div>' +
    ...
    '<div class="poss-chat-input-area">' +
      '<textarea class="poss-chat-input" id="possChatInput" placeholder="Ask about the investment, market, engines..." rows="1"></textarea>' +
  ...
  var SUGGESTION_POOLS = {
    default: [
      ...
      { cls: 'sg-compete', icon: '&#9876;', label: 'Market', q: 'How big is the addressable market?' },
      { cls: 'sg-growth', icon: '&#9650;', label: 'Engines', q: 'Explain the three revenue engines' },
      { cls: 'sg-data', icon: '&#9632;', label: 'Founder', q: 'Why is Jim uniquely qualified?' },
      { cls: 'sg-strategy', icon: '&#9670;', label: 'Ask', q: 'What is the $5M raise for?' },
      { cls: 'sg-compete', icon: '&#9876;', label: 'Comps', q: 'Who are the comparable companies?' },
      { cls: 'sg-growth', icon: '&#9650;', label: 'Traction', q: 'What traction exists today?' },
      { cls: 'sg-data', icon: '&#9632;', label: 'Flywheel', q: 'How does the brand flywheel work?' },
      { cls: 'sg-strategy', icon: '&#9670;', label: 'Framework', q: 'What is Release, Align, Become?' },
      { cls: 'sg-compete', icon: '&#9876;', label: 'Risks', q: 'What are the biggest risks?' },
    ]
  };
    ...
    messagesEl.innerHTML =
      '<div class="poss-chat-welcome">' +
        '<div class="poss-chat-welcome-icon">' +
          makeLogo(48) +
        '</div>' +
        '<h3>Investor Intelligence</h3>' +
        '<p class="poss-tagline">Ask anything about this deck.</p>' +
  ...
  exportBtn.addEventListener('click', function () {
    ...
    var text = 'The Possibility - Pitch Deck Chat Export\n';
    ...
    a.href = url;
    a.download = 'possibility-pitch-chat-' + new Date().toISOString().slice(0, 10) + '.txt';
    a.click();
  ...
  var SECTION_IDS = {
    '/pitch-deck.html': { hero: 'Cover', vision: 'The Vision', market: 'The Market', comps: 'Comparable Set', jim: 'Meet Jim Curtis', framework: 'The Framework', moment: 'Cultural Moment', platform: 'The Platform', app: 'The App', engines: 'Three Engines', flywheel: 'Brand Flywheel', revenue: 'Revenue', ask: 'The Ask', 'why-jim': 'Why Jim Wins' }
  };
